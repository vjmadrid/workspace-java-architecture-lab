...
public final class ValueDummyGenericEventConstant {
	...
	public static final String TEST_GENERIC_EVENT_1_PARENT_ID = GlobalConstant.EMPTY_STRING;
	...
	public static final String TEST_GENERIC_EVENT_2_PARENT_ID = GlobalConstant.EMPTY_STRING;
